...
3. Нужно использовать шаблон https://github.com/Lyumih/lim_rtest2 для создания своего проекта. Назовите проект, например, lim_market
...
1. Замените в файлах папки все вхождения "lim_rtest2" на ваше "lim_market" (имя компании_проект). Это заменит все view.tree файлы
2. Замените в файлах папки все вхождения "lim/rtest2" на ваше "lim/market" (имя компании/проект). Это заменит все deploy.yaml файлы
3. Замените в файлах папки все вхождения "Lyumih/lim_rtest2" на ваше "lim/lim_market" (имя GitHub/репозиторий). Это заменит все ссылки на репозитоий на ваше
